      ...
      <div className="rounded-2xl border border-border bg-card divide-y divide-border overflow-hidden">
        {list.map((a) => {
          ...
          return (
            <div
              key={a.id}
              className="flex items-start gap-4 p-4 hover:bg-surface/40 transition-colors"
            >
              <div
                className={cn("size-10 rounded-xl flex items-center justify-center shrink-0", tone)}
              >
