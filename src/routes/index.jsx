...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "AI-prioritized industrial alert dashboard with real-time monitoring.",
      },
      ...
      <section className="flex items-end justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 max-w-xl">
            Smart prioritization surfaces what matters now. {critical.length} critical signal
...
export const ChartCard = memo(function ChartCard({ title, children }) {
  return (
